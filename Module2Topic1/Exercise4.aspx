...
<body>
    ...
    <form runat="server">
       <asp:Label runat="server" Text="Full Name"></asp:Label><br />
        ...
        <asp:RequiredFieldValidator ID = "validFullName" runat="server" ControlToValidate="fullName" ErrorMessage="Please enter your valid full name">
        ...
        <asp:RangeValidator ID = "validAge" runat="server" ControlToValidate="age" Type="Integer" ErrorMessage="Please enter a valid age between 0 and 100" MinimumValue="0" MaximumValue="100">
        ...
        <asp:RegularExpressionValidator ID ="validEmail" runat="server" ControlToValidate="email" ErrorMessage="Please enter a valid email address" ValidationExpression="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$">
        ...
        <asp:CompareValidator ID = "validConfirmEMail" runat="server" ControlToValidate="confirmEmail" ControlToCompare="email" ErrorMessage="Emails do not match"><br/>
        </asp:CompareValidator><br/>

        <asp:Button Text="Submit" runat="server" UseSubmitBehavior="true" OnClick="Submit_Result" />
